				 ...
				 $.ajax({
			    		...
			    		success:function(data){
			    			if(data.code==00){
			       				userdata=JSON.parse( data.codeMessage );
			       				$('.box tbody tr').each(function(i,v){
			       					console.log( userdata.list[i].EXNM ) ;
