...
<head>
  ...
  <style >.layui-input {width:220px} </style>          <!-- 输入框 -->
...
<form class="layui-form" action="${pageContext.request.contextPath}/account/addAccount.do">      <!-- 传入url -->
  <div class="layui-form-item">
    <label class="layui-form-label">投资者账号</label>
    <div class="layui-input-inline">
      <input type="text" name="userid" lay-verify="InvestorAccount|number" autocomplete="off" placeholder="请输入您的账号" class="layui-input">
    </div>
  </div>
 ...
 <div class="layui-inline">
      ...
      <div class="layui-input-inline">
        <select name="ctpbrokerid" lay-verify="required" lay-search="">
  ...
  <div class="layui-form-item">
    <div class="layui-inline">
      ...
      <div class="layui-input-inline">
        <input type="text" name="marginnumber" lay-verify="required|lengthLimt" placeholder="请输入您的保证金监控中心账号" autocomplete="off" class="layui-input">
      </div>
    </div>
  </div>
  ...
  <div class="layui-form-item">
    <div class="layui-inline">
      ...
      <div class="layui-input-inline">
        <input type="password" name="marginpassword" lay-verify="required|marginpass" placeholder="请输入您的保证金监控中心密码" autocomplete="off" class="layui-input">
      </div>
    </div>
  </div>
  ...
  <div class="layui-form-item">
    ...
    <div class="layui-input-block">
      <input type="radio" name="isrank" value="1" title="是" checked="">
      <input type="radio" name="isrank" value="0" title="否">
    </div>
  </div>
  <div class="layui-form-item">
    <div class="layui-input-block">
...
layui.use(['form', 'layedit', 'laydate'], function(){
  ...
  form.on('submit(demo1)', function(data){
	  $.get('${pageContext.request.contextPath}/account/addAccount.do',$('.layui-form').serialize(),function(result){
	    		//console.log( result)
