...
require(['jquery','mmGrid','niceScroll','wdatepicker','dialog'],function($,mmGrid,niceScroll,wdatepicker,dialog){
    ...
    var cols = [
            ...
            { title:'错误码', name:'ognm',width:100, align:'left'},
            { title:'异常信息', name:'cmpt',width:100, align:'left'},
            { title:'异常日期', name:'mbtl',width:100,align:'right'},
            { title:'异常时间', name:'telp',width:80, align:'right'},
            { title:'状态', name:'ufax',width:80, align:'center'}
    ];
    var startDate=$('#d1').val(),
	    ...
	    pageNo= 1, 
	    pageSize=10,
	    KondorVo={"startDate":startDate,"endDate":endDate,"pageNo":pageNo,"pageSize":pageSize }
