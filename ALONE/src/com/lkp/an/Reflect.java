...
public class Reflect {
     ...
     */
    private static void settingsMethod() throws IOException, ClassNotFoundException, NoSuchMethodException, InstantiationException, IllegalAccessException, InvocationTargetException {
     ...
     * @throws InvocationTargetException
     */
    private static void getSingleFields(Class class3) throws NoSuchFieldException, NoSuchMethodException, InstantiationException, IllegalAccessException, InvocationTargetException {
     ...
     * @throws InvocationTargetException
     */
    private static void singPrivateConstruct(Class class3) throws NoSuchMethodException, InstantiationException, IllegalAccessException, InvocationTargetException {
     ...
     * @throws InvocationTargetException
     */
    private static void singleConstruct(Class class3) throws NoSuchMethodException, InstantiationException, IllegalAccessException, InvocationTargetException {
