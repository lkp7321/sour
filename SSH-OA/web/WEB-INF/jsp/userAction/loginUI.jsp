...
<s:form action="user_login" focusElement="loginNameInput">
    <div id="CenterAreaBg"> 
        <div id="CenterArea">
                ...
                <table BORDER=0 CELLSPACING=0 CELLPADDING=0 width=100%>
                    ...
                    <tr>
                        ...
                        <td rowspan="2" style="padding-left:10px;">
                        	<input type="image" tabindex="3" src="style/blue/images/login/userLogin_button.gif" />
                        </td>
                    </tr>
                    <tr>
            ...
            <div id="CopyRight"><a href="javascript:void(0)">&copy; 2017 版权所有 lz1307330@163.com</a></div>
        </div>
    </div>
    </s:form>
</body>
