...
public class DesService {
	...
	private final static String key = "SDB 2009";
	//加密
	public String encrypt(String str){
		return strEnc(str, DesService.key, null , null);
	}
		
	public String encrypt(String str,String key){
		return strEnc(str, key, null , null);
	}
	//解密
	public String decrypt(String str){
		return strDec(str, DesService.key, null, null);
	}
		
	public String decrypt(String str,String key){
		return strDec(str, key, null, null);
	}
	...
	private String bt64ToHex ( int[] byteData )
	{
		...
		for (int i = 0; i < 16; i++)
		{
			...
			for (int j = 0; j < 4; j++)
			{
				sb.append(byteData[i * 4 + j]);
			}
			bt = sb.toString();
//			hex += bt4ToHex(bt);
			sb1.append(bt4ToHex(bt));
		}
		hex = sb1.toString();
		return hex;
	}
	...
	private String hexToBt64 ( String hex )
	{
		...
		for (int i = 0; i < 16; i++)
		{
			sb.append(hexToBt4(hex.substring(i, i + 1)));
		}
		binary = sb.toString();
		return binary;
	}
